...
function Charizoid() {
  ...
  useEffect(() => {
    const walletId = getCookie('charizoidWalletId')
  ...
  return (
    <div>
      ...
      <div className="content">
        ...
        >
          Buy me a cup of coffee send some charizoid to 0x6159A1544461d7629868950Ba5dd97A84667501c
        </div>
      </div>
    </div>
  )
}
export default Charizoid
